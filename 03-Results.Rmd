...
In contrast, the OLS model’s Rsquared was 0.53, suggesting that the model explains about 53% of the variation. The relative prices predicted by each model for the potential listings provided by the client are shown in the table below:
